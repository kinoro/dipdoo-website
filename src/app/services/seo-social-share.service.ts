...
export class SeoSocialShareService {
    ...
    static defaultImage = "https://www.ponderegg.com/assets/ponderegg-icon-512.png";
    static defaultFacebookImage = "https://www.ponderegg.com/assets/ponderegg-icon-logo-fb.png";
